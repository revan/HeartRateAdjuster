                ...
                \hline
                        ...
                        \end{flushleft}
                                \begin{itemize}
                                        ...
                                        \item The device displays a heart rate lower than the peak heart rate.
                                \end{itemize}
                        \begin{flushleft}
...
\begin{center}
        \begin{tabular}{|C{15cm}|}
                ...
                \hline
                        ...
                        \end{flushleft}
                                \begin{itemize}
                                        \item The device displays a heart rate which is higher than the resting heart rate.
                                \end{itemize}
                        \begin{flushleft}
                                \textbf{Postconditions: }
                        \end{flushleft}
...
\begin{center}
        \begin{tabular}{|C{15cm}|}
                ...
                \hline
                        ...
                        \end{flushleft}
                                \begin{itemize}
                                        \item The device is playing a song which needs to be changed manually.
                                \end{itemize}
                        \begin{flushleft}
                                \textbf{Postconditions: }
                        \end{flushleft}
...
\begin{center}
        \begin{tabular}{|C{15cm}|}
                ...
                \hline
                        ...
                        \end{flushleft}
                                \begin{itemize}
                                        \item The workout has been completed and statistics need to be displayed.
                                        \item The workout is in progress but statistics need to be displayed.
                                \end{itemize}
                        \begin{flushleft}
                                \textbf{Postconditions: }
                        \end{flushleft}
...
\begin{itemize}
\item {\bf Precondition: } The system displays the selection menu for heart rate
...
\begin{itemize}
\item The system starts recording the heart rate of the user and the data from the workout if not already recording.
\item The system uses the initial resting heart rate as a target for the music selection algorith.
\end{itemize}
...
\section{\centerline{Gantt Chart}}
\begin{figure}[H]
\centering
...
\section{\centerline{Breakdown of Responsibilities}}
