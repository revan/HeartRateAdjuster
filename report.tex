...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.40]{img/Interaction_Diagrams/UC-1_increaseHeartRate.png}\\
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.40]{img/Interaction_Diagrams/UC-3_getNextSong.png}\\
...
\begin{figure}[H]
	\includegraphics[scale=.40]{img/Interaction_Diagrams/UC-4_pausePlayback.png}\\
...
\begin{figure}[H]
	\includegraphics[scale=.40]{img/Interaction_Diagrams/UC-5_getStatistics.png}\\
...
\begin{figure}[H]
	\includegraphics[scale=.40]{img/Interaction_Diagrams/UC-6_getHeartRate.png}\\
