...
\begin{center}
	\begin{tabular}{|C{2cm}|C{2cm}|C{8cm}|}
		...
		\hline
			REQ-6 & 2 & The system shall output useful graphs of user workout data on the website to demonstrate the effects of music on BPM.\\
        \hline
    \end{tabular}
\end{center}
\begin{center}
...
\begin{center}
        \begin{tabular}{|C{1cm}|C{1cm}|C{1cm}|C{1cm}|C{1cm}|C{1cm}|C{1cm}|C{1cm}|}
                ...
                \hline
                        REQ-5 & 3 & X & X & & & X & \\
                \hline
                        REQ-6 & 2 & & & & & X &  \\ %something wrong here. Needs to be included in a use case
                \hline
                        REQ-7 & 1 & X & X & X & & &  \\
                \hline
                        REQ-8 & 1 & & & & & X  &  \\
		...
		\hline	
			REQ-12 & 1 & & & & X & & \\
                ...
                \hline
                        Total Weight & & 37 & 37 & 21 & 17 & 23 & 17  \\
                \hline
        \end{tabular}
\end{center}
...
\begin{center}
        \begin{tabular}{|C{15cm}|}
                ...
                \hline
                        \begin{flushleft}
                                \textbf{Related Requirements: } REQ-1, REQ-5, REQ-8, REQ-9, REQ-13, REQ-14, REQ-16
                        \end{flushleft}
                        \begin{flushleft}
                                \textbf{Initiating Actor: } User
                        \end{flushleft}
...
\begin{center}
        \begin{tabular}{|C{15cm}|}
                ...
                \hline
                        \begin{flushleft}
                                \textbf{Related Requirements: } REQ-1, REQ-11, REQ-13, REQ-16
                        \end{flushleft}
                        \begin{flushleft}
                                \textbf{Initiating Actor: } User
                        \end{flushleft}
...
\begin{center}
        \begin{tabular}{|C{2cm}|C{5cm}|C{1cm}|C{1cm}|C{1cm}|}
                ...
                \hline
                         \multicolumn{5}{c}{Environmental Factor Total (TFT)} & 15.5 \\
                \hline
        \end{tabular}
\end{center}
