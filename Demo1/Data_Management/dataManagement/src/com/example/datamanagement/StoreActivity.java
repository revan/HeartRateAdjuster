...
public class StoreActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		db.addRecord(new Record(60+(int)(Math.random() *((80-60)+1)),1235,"Bono","Pop","Beautiful Day")); // load some sample records into the database
		...
		db.addRecord(new Record(60+(int)(Math.random() *((80-60)+1)),4235,"Bono","Pop","Beautiful Day"));
		db.addRecord(new Record(60+(int)(Math.random() *((80-60)+1)),5235,"Bono","Pop","Beautiful Day"));
		...
		db.addRecord(new Record(60+(int)(Math.random() *((80-60)+1)),8235,"Bono","Pop","Beautiful Day"));
		...
		db.addRecord(new Record(60+(int)(Math.random() *((80-60)+1)),11235,"Bono","Pop","Beautiful Day"));
		db.addRecord(new Record(60+(int)(Math.random() *((80-60)+1)),12235,"Bono","Pop","Beautiful Day"));
		db.addRecord(new Record(60+(int)(Math.random() *((80-60)+1)),13236,"K'naan","Cultural","Wavin Flag"));
		...
		db.addRecord(new Record(60+(int)(Math.random() *((80-60)+1)),16236,"K'naan","Cultural","Wavin Flag"));
		...
		db.addRecord(new Record(60+(int)(Math.random() *((80-60)+1)),19236,"K'naan","Cultural","Wavin Flag"));
